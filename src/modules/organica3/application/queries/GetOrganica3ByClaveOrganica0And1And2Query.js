...
exports.GetOrganica3ByClaveOrganica0And1And2Query = void 0;
var errors_js_1 = require("../../domain/errors.js");
var GetOrganica3ByClaveOrganica0And1And2Query = /** @class */ (function () {
    function GetOrganica3ByClaveOrganica0And1And2Query(organica3Repo) {
        this.organica3Repo = organica3Repo;
    }
    GetOrganica3ByClaveOrganica0And1And2Query.prototype.execute = function (claveOrganica0, claveOrganica1, claveOrganica2, userId) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, this.organica3Repo.findByClaveOrganica0And1And2(claveOrganica0, claveOrganica1, claveOrganica2)];
                    case 2:
                        result = _a.sent();
    ...
    GetOrganica3ByClaveOrganica0And1And2Query.prototype.validateClaveOrganica0 = function (clave) {
    ...
    GetOrganica3ByClaveOrganica0And1And2Query.prototype.validateClaveOrganica1 = function (clave) {
        if (!clave || typeof clave !== 'string') {
    ...
    GetOrganica3ByClaveOrganica0And1And2Query.prototype.validateClaveOrganica2 = function (clave) {
        if (!clave || typeof clave !== 'string') {
    ...
    return GetOrganica3ByClaveOrganica0And1And2Query;
}());
exports.GetOrganica3ByClaveOrganica0And1And2Query = GetOrganica3ByClaveOrganica0And1And2Query;
