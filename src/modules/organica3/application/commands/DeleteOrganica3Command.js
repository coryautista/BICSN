...
exports.DeleteOrganica3Command = void 0;
var errors_js_1 = require("../../domain/errors.js");
var DeleteOrganica3Command = /** @class */ (function () {
    function DeleteOrganica3Command(organica3Repo) {
        this.organica3Repo = organica3Repo;
    }
    DeleteOrganica3Command.prototype.execute = function (claveOrganica0, claveOrganica1, claveOrganica2, claveOrganica3, userId) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, this.checkOrganica3InUse(claveOrganica0, claveOrganica1, claveOrganica2, claveOrganica3)];
                    case 3:
                        // Verificar si la entidad está siendo utilizada (lógica de negocio)
                        _a.sent();
                    ...
                    case 4:
                        ...
                        if (!deleted) {
                            ...
                            throw new errors_js_1.Organica3DeletionError('La eliminación de la organica3 falló');
                        }
                        ...
                        return [2 /*return*/, { claveOrganica0: claveOrganica0, claveOrganica1: claveOrganica1, claveOrganica2: claveOrganica2, claveOrganica3: claveOrganica3, deleted: true }];
                    case 5:
                        error_1 = _a.sent();
    ...
    DeleteOrganica3Command.prototype.validateClaveOrganica0 = function (clave) {
    ...
    DeleteOrganica3Command.prototype.validateClaveOrganica1 = function (clave) {
        if (!clave || typeof clave !== 'string') {
    ...
    DeleteOrganica3Command.prototype.validateClaveOrganica2 = function (clave) {
        if (!clave || typeof clave !== 'string') {
    ...
    DeleteOrganica3Command.prototype.validateClaveOrganica3 = function (clave) {
        if (!clave || typeof clave !== 'string') {
    ...
    DeleteOrganica3Command.prototype.checkOrganica3InUse = function (claveOrganica0, claveOrganica1, claveOrganica2, claveOrganica3) {
        return __awaiter(this, void 0, void 0, function () {
            var inUse;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.organica3Repo.isInUse(claveOrganica0, claveOrganica1, claveOrganica2, claveOrganica3)];
                    case 1:
                        inUse = _a.sent();
                        if (inUse) {
                            console.warn('ORGANICA3_COMMAND_WARNING', {
                            ...
                            throw new errors_js_1.Organica3InUseError(claveOrganica0, claveOrganica1, claveOrganica2, claveOrganica3);
                        }
                        return [2 /*return*/];
                }
            });
    ...
    return DeleteOrganica3Command;
}());
exports.DeleteOrganica3Command = DeleteOrganica3Command;
