...
exports.UpdateOrganica3Command = void 0;
var errors_js_1 = require("../../domain/errors.js");
var UpdateOrganica3Command = /** @class */ (function () {
    function UpdateOrganica3Command(organica3Repo) {
        this.organica3Repo = organica3Repo;
    }
    UpdateOrganica3Command.prototype.execute = function (claveOrganica0, claveOrganica1, claveOrganica2, claveOrganica3, data, userId) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 4, , 5]);
                        return [4 /*yield*/, this.organica3Repo.findById(claveOrganica0, claveOrganica1, claveOrganica2, claveOrganica3)];
                    case 2:
                        existing = _a.sent();
                        if (!existing) {
                            ...
                            throw new errors_js_1.Organica3NotFoundError(claveOrganica0, claveOrganica1, claveOrganica2, claveOrganica3);
                        }
    ...
    UpdateOrganica3Command.prototype.validateClaveOrganica0 = function (clave) {
    ...
    UpdateOrganica3Command.prototype.validateClaveOrganica1 = function (clave) {
        if (!clave || typeof clave !== 'string') {
    ...
    UpdateOrganica3Command.prototype.validateClaveOrganica2 = function (clave) {
        if (!clave || typeof clave !== 'string') {
    ...
    UpdateOrganica3Command.prototype.validateClaveOrganica3 = function (clave) {
        if (!clave || typeof clave !== 'string') {
    ...
    UpdateOrganica3Command.prototype.validateDescripcion = function (descripcion) {
    ...
    UpdateOrganica3Command.prototype.validateTitular = function (titular) {
    ...
    UpdateOrganica3Command.prototype.validateCalleNum = function (calleNum) {
    ...
    UpdateOrganica3Command.prototype.validateFraccionamiento = function (fraccionamiento) {
    ...
    UpdateOrganica3Command.prototype.validateCodigoPostal = function (codigoPostal) {
    ...
    UpdateOrganica3Command.prototype.validateTelefono = function (telefono) {
    ...
    UpdateOrganica3Command.prototype.validateFax = function (fax) {
    ...
    UpdateOrganica3Command.prototype.validateLocalidad = function (localidad) {
    ...
    UpdateOrganica3Command.prototype.validateMunicipio = function (municipio) {
    ...
    UpdateOrganica3Command.prototype.validateEstado = function (estado) {
    ...
    UpdateOrganica3Command.prototype.validateEstatus = function (estatus) {
    ...
    UpdateOrganica3Command.prototype.validateFechaFin = function (fechaFin) {
        if (fechaFin === null) {
    ...
    return UpdateOrganica3Command;
}());
exports.UpdateOrganica3Command = UpdateOrganica3Command;
