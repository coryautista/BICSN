...
exports.UpdatePersonalCommand = void 0;
var errors_js_1 = require("../../domain/errors.js");
var UpdatePersonalCommand = /** @class */ (function () {
    function UpdatePersonalCommand(personalRepo) {
        this.personalRepo = personalRepo;
    }
    UpdatePersonalCommand.prototype.execute = function (interno, data, userId) {
        return __awaiter(this, void 0, void 0, function () {
            var timestamp, existing, personal, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        timestamp = new Date().toISOString();
                        console.log("[".concat(timestamp, "] [Usuario: ").concat(userId, "] Iniciando actualizaci\u00F3n de registro personal"), {
                            interno: interno,
                    ...
                    case 1:
                        ...
                        if (!interno || typeof interno !== 'number' || interno <= 0 || !Number.isInteger(interno)) {
                            throw new errors_js_1.PersonalInvalidInternoError(interno);
                        }
                        // Validar datos de entrada
                        return [4 /*yield*/, this.validateUpdateData(data)];
                    case 2:
                        // Validar datos de entrada
                        _a.sent();
                        return [4 /*yield*/, this.personalRepo.findById(interno)];
                    case 3:
                        existing = _a.sent();
                        if (!existing) {
                            throw new errors_js_1.PersonalNotFoundError(interno);
                        }
                        return [4 /*yield*/, this.personalRepo.update(interno, data)];
                    case 4:
                        personal = _a.sent();
                        console.log("[".concat(timestamp, "] [Usuario: ").concat(userId, "] Registro personal actualizado exitosamente"), {
                    ...
                    case 5:
                        error_1 = _a.sent();
                        console.error("[".concat(timestamp, "] [Usuario: ").concat(userId, "] Error en actualizaci\u00F3n de registro personal"), {
                            interno: interno,
                            camposActualizar: Object.keys(data),
    ...
    UpdatePersonalCommand.prototype.validateUpdateData = function (data) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    return UpdatePersonalCommand;
}());
exports.UpdatePersonalCommand = UpdatePersonalCommand;
