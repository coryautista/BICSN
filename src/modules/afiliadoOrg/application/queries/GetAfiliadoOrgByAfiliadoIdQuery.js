...
exports.GetAfiliadoOrgByAfiliadoIdQuery = void 0;
...
var GetAfiliadoOrgByAfiliadoIdQuery = /** @class */ (function () {
    function GetAfiliadoOrgByAfiliadoIdQuery(afiliadoOrgRepo) {
        this.afiliadoOrgRepo = afiliadoOrgRepo;
    }
    GetAfiliadoOrgByAfiliadoIdQuery.prototype.execute = function (afiliadoId) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, this.afiliadoOrgRepo.findByAfiliadoId(afiliadoId)];
                    case 2:
                        results = _a.sent();
                    ...
                    case 3:
                        error_1 = _a.sent();
                        logger.error(__assign(__assign({}, logContext), { error: error_1.message, stack: error_1.stack }), 'Error al consultar relaciones afiliado-org por afiliado ID');
                        throw new errors_js_1.AfiliadoOrgQueryError('Error al consultar relaciones afiliado-org por afiliado ID', {
    ...
    GetAfiliadoOrgByAfiliadoIdQuery.prototype.validateInput = function (afiliadoId) {
    ...
    return GetAfiliadoOrgByAfiliadoIdQuery;
}());
exports.GetAfiliadoOrgByAfiliadoIdQuery = GetAfiliadoOrgByAfiliadoIdQuery;
