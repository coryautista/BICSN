...
exports.UpdateAfiliadoOrgCommand = void 0;
...
var UpdateAfiliadoOrgCommand = /** @class */ (function () {
    function UpdateAfiliadoOrgCommand(afiliadoOrgRepo) {
        this.afiliadoOrgRepo = afiliadoOrgRepo;
    }
    UpdateAfiliadoOrgCommand.prototype.execute = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 4, , 5]);
                        return [4 /*yield*/, this.afiliadoOrgRepo.findById(data.id)];
                    case 2:
                        existing = _a.sent();
                        if (!existing) {
                            logger.warn(__assign(__assign({}, logContext), { afiliadoOrgId: data.id }), 'Relación afiliado-org no encontrada para actualización');
                            throw new errors_js_1.AfiliadoOrgNotFoundError({ id: data.id });
                        }
                        return [4 /*yield*/, this.afiliadoOrgRepo.update(data)];
                    case 3:
                        result = _a.sent();
                        logger.info(__assign(__assign({}, logContext), { afiliadoOrgId: result.id }), 'Relación afiliado-org actualizada exitosamente');
                        return [2 /*return*/, result];
                    case 4:
                        error_1 = _a.sent();
                        if (error_1 instanceof errors_js_1.AfiliadoOrgNotFoundError ||
                            error_1 instanceof errors_js_1.InvalidAfiliadoOrgDataError ||
                        ...
                        logger.error(__assign(__assign({}, logContext), { error: error_1.message, stack: error_1.stack }), 'Error al actualizar relación afiliado-org');
                        throw new errors_js_1.AfiliadoOrgUpdateError('Error interno al actualizar relación afiliado-org', {
    ...
    UpdateAfiliadoOrgCommand.prototype.validateInput = function (data) {
        // Validar ID
        if (!data.id || data.id <= 0) {
            throw new errors_js_1.InvalidAfiliadoOrgDataError('id', 'El ID es requerido y debe ser positivo');
        }
    ...
    UpdateAfiliadoOrgCommand.prototype.validateOrgHierarchy = function (data) {
        var _a, _b, _c;
        ...
        var hasNivel1 = data.nivel1Id !== undefined && data.nivel1Id !== null;
        ...
        var hasNivel2 = data.nivel2Id !== undefined && data.nivel2Id !== null;
        ...
        var hasNivel3 = data.nivel3Id !== undefined && data.nivel3Id !== null;
    ...
    UpdateAfiliadoOrgCommand.prototype.validateFechaMovAlt = function (fecha) {
    ...
    return UpdateAfiliadoOrgCommand;
}());
exports.UpdateAfiliadoOrgCommand = UpdateAfiliadoOrgCommand;
