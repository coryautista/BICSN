...
exports.GetMunicipioByIdQuery = void 0;
...
var GetMunicipioByIdQuery = /** @class */ (function () {
    function GetMunicipioByIdQuery(municipioRepo) {
        this.municipioRepo = municipioRepo;
    }
    GetMunicipioByIdQuery.prototype.execute = function (input, userId) {
        return __awaiter(this, void 0, void 0, function () {
            var municipio, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        throw new errors_js_1.MunicipioError('Error interno al consultar municipio', 'MUNICIPIO_QUERY_ERROR', 500);
                    case 3: return [2 /*return*/];
                }
            });
        });
    };
    GetMunicipioByIdQuery.prototype.validateId = function (municipioId) {
    ...
    return GetMunicipioByIdQuery;
}());
exports.GetMunicipioByIdQuery = GetMunicipioByIdQuery;
