...
exports.GetMunicipiosByEstadoQuery = void 0;
...
var GetMunicipiosByEstadoQuery = /** @class */ (function () {
    function GetMunicipiosByEstadoQuery(municipioRepo) {
        this.municipioRepo = municipioRepo;
    }
    GetMunicipiosByEstadoQuery.prototype.execute = function (input, userId) {
        return __awaiter(this, void 0, void 0, function () {
            var municipios, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.municipioRepo.findByEstado(input.estadoId)];
                    case 1:
                        municipios = _a.sent();
                        logger.info({
                            operation: 'getMunicipiosByEstado',
                        ...
                        return [2 /*return*/, municipios];
                    case 2:
                        error_1 = _a.sent();
                        if (error_1 instanceof errors_js_1.MunicipioInvalidEstadoError) {
                            throw error_1;
                        }
                        logger.error({
                            operation: 'getMunicipiosByEstado',
                        ...
                        throw new errors_js_1.MunicipioError('Error interno al consultar municipios', 'MUNICIPIO_QUERY_ERROR', 500);
                    case 3: return [2 /*return*/];
                }
            });
        });
    };
    GetMunicipiosByEstadoQuery.prototype.validateEstadoId = function (estadoId) {
        if (!estadoId || typeof estadoId !== 'string') {
            throw new errors_js_1.MunicipioInvalidEstadoError('debe ser una cadena de texto');
        }
        var estadoIdTrimmed = estadoId.trim();
    ...
    return GetMunicipiosByEstadoQuery;
}());
exports.GetMunicipiosByEstadoQuery = GetMunicipiosByEstadoQuery;
