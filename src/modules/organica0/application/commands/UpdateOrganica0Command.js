...
exports.UpdateOrganica0Command = void 0;
var errors_js_1 = require("../../domain/errors.js");
var UpdateOrganica0Command = /** @class */ (function () {
    function UpdateOrganica0Command(organica0Repo) {
        this.organica0Repo = organica0Repo;
    }
    UpdateOrganica0Command.prototype.execute = function (claveOrganica, data, userId) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, this.organica0Repo.update(claveOrganica, data)];
                    case 3:
                        result = _a.sent();
    ...
    UpdateOrganica0Command.prototype.validateClaveOrganica = function (clave) {
        if (!clave || typeof clave !== 'string') {
            throw new errors_js_2.Organica0InvalidClaveError('La clave organica0 es requerida y debe ser una cadena de texto');
        }
        var trimmed = clave.trim();
        if (trimmed.length === 0) {
            throw new errors_js_2.Organica0InvalidClaveError('La clave organica0 no puede estar vacía');
        }
        if (trimmed.length > 50) {
            throw new errors_js_2.Organica0InvalidClaveError('La clave organica0 no puede tener más de 50 caracteres');
        }
    };
    UpdateOrganica0Command.prototype.validateNombreOrganica = function (nombre) {
        if (typeof nombre !== 'string') {
            throw new errors_js_1.Organica0InvalidNombreError('El nombre organica0 debe ser una cadena de texto');
        }
    ...
    UpdateOrganica0Command.prototype.validateEstatus = function (estatus) {
        if (typeof estatus !== 'string') {
            throw new errors_js_1.Organica0InvalidEstatusError('El estatus debe ser una cadena de texto');
        }
    ...
    UpdateOrganica0Command.prototype.validateFechaFin = function (fechaFin) {
        if (fechaFin === null) {
    ...
    return UpdateOrganica0Command;
}());
exports.UpdateOrganica0Command = UpdateOrganica0Command;
// Importar el error que falta
var errors_js_2 = require("../../domain/errors.js");
