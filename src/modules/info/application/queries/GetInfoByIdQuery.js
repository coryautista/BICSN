...
exports.GetInfoByIdQuery = void 0;
...
var GetInfoByIdQuery = /** @class */ (function () {
    function GetInfoByIdQuery(infoRepo) {
        this.infoRepo = infoRepo;
    }
    GetInfoByIdQuery.prototype.execute = function (input, _userId) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        throw new errors_js_1.InfoRepositoryError('findById', error_1);
                    case 3: return [2 /*return*/];
                }
            });
        });
    };
    return GetInfoByIdQuery;
}());
exports.GetInfoByIdQuery = GetInfoByIdQuery;
