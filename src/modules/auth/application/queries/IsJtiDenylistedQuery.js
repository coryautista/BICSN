...
exports.IsJtiDenylistedQuery = void 0;
...
var IsJtiDenylistedQuery = /** @class */ (function () {
    function IsJtiDenylistedQuery(authRepo) {
        this.authRepo = authRepo;
    }
    IsJtiDenylistedQuery.prototype.execute = function (jti) {
        return __awaiter(this, void 0, void 0, function () {
            var isDenylisted, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        logger.debug('Verificando si JTI está en lista negra', { jti: jti });
                        // Validar entrada básica
                        if (!jti || jti.trim().length === 0) {
                            logger.warn('JTI vacío o inválido en verificación de lista negra');
                            return [2 /*return*/, false]; // Un JTI inválido no está en lista negra
                        }
                        return [4 /*yield*/, this.authRepo.isJtiDenylisted(jti)];
                    case 1:
                        isDenylisted = _a.sent();
                        logger.debug('Verificación de JTI completada', {
                            jti: jti,
                            isDenylisted: isDenylisted
                        });
                        return [2 /*return*/, isDenylisted];
                    case 2:
                        error_1 = _a.sent();
                        ...
                        throw new errors_js_1.AuthSystemError('Error al verificar el estado del token');
                    case 3: return [2 /*return*/];
                }
            });
        });
    };
    return IsJtiDenylistedQuery;
}());
exports.IsJtiDenylistedQuery = IsJtiDenylistedQuery;
