...
exports.LogoutAllCommand = void 0;
...
var LogoutAllCommand = /** @class */ (function () {
    function LogoutAllCommand(authRepo) {
        this.authRepo = authRepo;
    }
    LogoutAllCommand.prototype.execute = function (input) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.authRepo.revokeAllRefreshTokensForUser(input.userId)];
                    case 1:
                        _a.sent();
                    ...
                    case 2:
                        ...
                        throw new errors_js_1.LogoutFailedError('Error al cerrar todas las sesiones');
