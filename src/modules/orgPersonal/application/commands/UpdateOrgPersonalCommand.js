...
exports.UpdateOrgPersonalCommand = void 0;
var errors_js_1 = require("../../domain/errors.js");
var UpdateOrgPersonalCommand = /** @class */ (function () {
    function UpdateOrgPersonalCommand(orgPersonalRepo) {
        this.orgPersonalRepo = orgPersonalRepo;
    }
    UpdateOrgPersonalCommand.prototype.execute = function (interno, data, userId) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        console.log("[ORG_PERSONAL] Actualizando registro orgPersonal interno: ".concat(interno, ", usuario: ").concat(userId || 'desconocido'));
                        // Validaciones de entrada
                        if (!interno || typeof interno !== 'number' || interno <= 0 || !Number.isInteger(interno)) {
                            throw new errors_js_1.OrgPersonalInvalidInternoError(interno);
                        }
                        this.validateUpdateData(data);
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 4, , 5]);
                        return [4 /*yield*/, this.orgPersonalRepo.findById(interno)];
                    case 2:
                        existing = _a.sent();
                        if (!existing) {
                            throw new errors_js_1.OrgPersonalNotFoundError(interno);
                        }
                        return [4 /*yield*/, this.orgPersonalRepo.update(interno, data)];
                    case 3:
                        result = _a.sent();
                        console.log("[ORG_PERSONAL] Registro orgPersonal actualizado exitosamente: interno ".concat(interno));
                        return [2 /*return*/, result];
                    case 4:
                        error_1 = _a.sent();
                        // Si ya es un error de dominio, lo propagamos
                        if (error_1 instanceof errors_js_1.OrgPersonalNotFoundError ||
                        ...
                        console.error("[ORG_PERSONAL] Error al actualizar registro orgPersonal interno ".concat(interno, ":"), error_1);
                        throw error_1;
    ...
    UpdateOrgPersonalCommand.prototype.validateUpdateData = function (data) {
    ...
    UpdateOrgPersonalCommand.prototype.validateClaveOrganica = function (clave, nivel) {
    ...
    return UpdateOrgPersonalCommand;
}());
exports.UpdateOrgPersonalCommand = UpdateOrgPersonalCommand;
