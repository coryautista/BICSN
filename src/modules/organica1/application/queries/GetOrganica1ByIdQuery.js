...
exports.GetOrganica1ByIdQuery = void 0;
var errors_js_1 = require("../../domain/errors.js");
var GetOrganica1ByIdQuery = /** @class */ (function () {
    function GetOrganica1ByIdQuery(organica1Repo) {
        this.organica1Repo = organica1Repo;
    }
    GetOrganica1ByIdQuery.prototype.execute = function (claveOrganica0, claveOrganica1, userId) {
        return __awaiter(this, void 0, void 0, function () {
            var organica1, error_1;
    ...
    GetOrganica1ByIdQuery.prototype.validateClaveOrganica0 = function (clave) {
    ...
    GetOrganica1ByIdQuery.prototype.validateClaveOrganica1 = function (clave) {
        if (!clave || typeof clave !== 'string') {
    ...
    return GetOrganica1ByIdQuery;
}());
exports.GetOrganica1ByIdQuery = GetOrganica1ByIdQuery;
