...
exports.UpdateOrganica1Command = void 0;
var errors_js_1 = require("../../domain/errors.js");
var UpdateOrganica1Command = /** @class */ (function () {
    function UpdateOrganica1Command(organica1Repo) {
        this.organica1Repo = organica1Repo;
    }
    UpdateOrganica1Command.prototype.execute = function (claveOrganica0, claveOrganica1, data, userId) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 4, , 5]);
                        return [4 /*yield*/, this.organica1Repo.findById(claveOrganica0, claveOrganica1)];
                    case 2:
                        existing = _a.sent();
                        if (!existing) {
                            ...
                            throw new errors_js_1.Organica1NotFoundError(claveOrganica0, claveOrganica1);
                        }
    ...
    UpdateOrganica1Command.prototype.validateClaveOrganica0 = function (clave) {
    ...
    UpdateOrganica1Command.prototype.validateClaveOrganica1 = function (clave) {
        if (!clave || typeof clave !== 'string') {
    ...
    UpdateOrganica1Command.prototype.validateDescripcion = function (descripcion) {
    ...
    UpdateOrganica1Command.prototype.validateTitular = function (titular) {
    ...
    UpdateOrganica1Command.prototype.validateRfc = function (rfc) {
    ...
    UpdateOrganica1Command.prototype.validateImss = function (imss) {
    ...
    UpdateOrganica1Command.prototype.validateInfonavit = function (infonavit) {
    ...
    UpdateOrganica1Command.prototype.validateEstatus = function (estatus) {
        if (typeof estatus !== 'string') {
            throw new errors_js_1.Organica1InvalidEstatusError('El estatus debe ser una cadena de texto');
        }
    ...
    UpdateOrganica1Command.prototype.validateFechaFin = function (fechaFin) {
        if (fechaFin === null) {
    ...
    return UpdateOrganica1Command;
}());
exports.UpdateOrganica1Command = UpdateOrganica1Command;
