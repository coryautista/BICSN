...
exports.DeleteOrganica1Command = void 0;
var errors_js_1 = require("../../domain/errors.js");
var DeleteOrganica1Command = /** @class */ (function () {
    function DeleteOrganica1Command(organica1Repo) {
        this.organica1Repo = organica1Repo;
    }
    DeleteOrganica1Command.prototype.execute = function (claveOrganica0, claveOrganica1, userId) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, this.checkOrganica1InUse(claveOrganica0, claveOrganica1)];
                    case 3:
                        // Verificar si la entidad está siendo utilizada (lógica de negocio)
                        _a.sent();
                    ...
                    case 4:
                        ...
                        return [2 /*return*/, { claveOrganica0: claveOrganica0, claveOrganica1: claveOrganica1, deleted: true }];
                    case 5:
                        error_1 = _a.sent();
                        console.error('ORGANICA1_COMMAND_ERROR', {
                            operation: 'DELETE_ORGANICA1',
    ...
    DeleteOrganica1Command.prototype.validateClaveOrganica0 = function (clave) {
    ...
    DeleteOrganica1Command.prototype.validateClaveOrganica1 = function (clave) {
        if (!clave || typeof clave !== 'string') {
    ...
    DeleteOrganica1Command.prototype.checkOrganica1InUse = function (claveOrganica0, claveOrganica1) {
        return __awaiter(this, void 0, void 0, function () {
            var inUse;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.organica1Repo.isInUse(claveOrganica0, claveOrganica1)];
                    case 1:
                        inUse = _a.sent();
                        if (inUse) {
                            console.warn('ORGANICA1_COMMAND_WARNING', {
                            ...
                            throw new errors_js_1.Organica1InUseError(claveOrganica0, claveOrganica1);
                        }
                        return [2 /*return*/];
                }
            });
    ...
    return DeleteOrganica1Command;
}());
exports.DeleteOrganica1Command = DeleteOrganica1Command;
