 ...
 */
export class Organica1NotFoundError extends Organica1Error {
 ...
 */
export class Organica1AlreadyExistsError extends Organica1Error {
  constructor(claveOrganica0: string, claveOrganica1: string) {
    super(
 ...
 */
export class Organica1InvalidClaveOrganica0Error extends Organica1Error {
 ...
 */
export class Organica1InvalidClaveOrganica1Error extends Organica1Error {
  constructor(details: string) {
    super(
 ...
 */
export class Organica1InvalidDescripcionError extends Organica1Error {
  constructor(details: string) {
    super(
 ...
 */
export class Organica1InvalidTitularError extends Organica1Error {
  constructor(details: string) {
    super(
 ...
 */
export class Organica1InvalidRfcError extends Organica1Error {
  constructor(details: string) {
    super(
 ...
 */
export class Organica1InvalidImssError extends Organica1Error {
  constructor(details: string) {
    super(
 ...
 */
export class Organica1InvalidInfonavitError extends Organica1Error {
  constructor(details: string) {
    super(
 ...
 */
export class Organica1InvalidEstatusError extends Organica1Error {
  constructor(details: string) {
    super(
 ...
 */
export class Organica1InvalidFechaError extends Organica1Error {
  constructor(details: string) {
    super(
 ...
 */
export class Organica1InUseError extends Organica1Error {
  constructor(claveOrganica0: string, claveOrganica1: string) {
    super(
 ...
 */
export class Organica1ParentNotFoundError extends Organica1Error {
 ...
 */
export class Organica1PermissionError extends Organica1Error {
