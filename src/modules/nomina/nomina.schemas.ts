...
export const NominaAplicacionQnalScopeSchema = z.object({
...
export const CargarNominaAplicacionQnalTxtFieldsSchema = NominaAplicacionQnalScopeSchema;

export const GetNominaAplicacionQnalCargaVigenteSchema = NominaAplicacionQnalScopeSchema;
