...
export const MovimientoSchema = z.object({
  ...
  fechaMovimiento: z.string().date().nullable(),
  observaciones: z.string().max(1024).nullable(),
  entregaRendimiento: z.enum(['Si', 'No']).nullable(),
...
export const CreateMovimientoSchema = z.object({
  ...
  fechaMovimiento: z.string().date().nullable().optional(),
  observaciones: z.string().max(1024).nullable().optional(),
  entregaRendimiento: z.enum(['Si', 'No']).nullable().optional(),
