...
exports.GetCalleByIdQuery = void 0;
...
var GetCalleByIdQuery = /** @class */ (function () {
    function GetCalleByIdQuery(calleRepo) {
        this.calleRepo = calleRepo;
    }
    GetCalleByIdQuery.prototype.execute = function (calleId) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        logger.debug('Ejecutando consulta de calle por ID', { calleId: calleId });
                        // Validar calleId
                        if (!calleId || typeof calleId !== 'number' || calleId <= 0) {
                            throw new errors_js_1.InvalidCalleDataError('ID de calle inválido para consulta');
                        }
                        return [4 /*yield*/, this.calleRepo.findById(calleId)];
                    case 1:
                        calle = _a.sent();
                        if (!calle) {
                            logger.warn('Calle no encontrada por ID', { calleId: calleId });
                            throw new errors_js_1.CalleNotFoundError(calleId);
                        }
                    ...
                    case 2:
                        error_1 = _a.sent();
                        if (error_1 instanceof errors_js_1.CalleNotFoundError || error_1 instanceof errors_js_1.InvalidCalleDataError) {
                            throw error_1;
                        }
                        ...
                        throw new errors_js_1.CalleQueryError('findById', 'Error interno en consulta de calle');
                    case 3: return [2 /*return*/];
                }
            });
        });
    };
    return GetCalleByIdQuery;
}());
exports.GetCalleByIdQuery = GetCalleByIdQuery;
