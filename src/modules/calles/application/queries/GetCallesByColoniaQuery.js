...
exports.GetCallesByColoniaQuery = void 0;
...
var GetCallesByColoniaQuery = /** @class */ (function () {
    function GetCallesByColoniaQuery(calleRepo) {
        this.calleRepo = calleRepo;
    }
    GetCallesByColoniaQuery.prototype.execute = function (coloniaId) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        logger.debug('Ejecutando consulta de calles por colonia', { coloniaId: coloniaId });
                        // Validar coloniaId
                        if (!coloniaId || typeof coloniaId !== 'number' || coloniaId <= 0) {
                            throw new errors_js_1.InvalidColoniaIdError(coloniaId);
                        }
                        return [4 /*yield*/, this.calleRepo.findByColonia(coloniaId)];
                    case 1:
                        calles = _a.sent();
                    ...
                    case 2:
                        error_1 = _a.sent();
                        if (error_1 instanceof errors_js_1.InvalidColoniaIdError) {
                            throw error_1;
                        }
                        ...
                        throw new errors_js_1.CalleQueryError('findByColonia', 'Error interno en consulta de calles por colonia');
                    case 3: return [2 /*return*/];
                }
            });
        });
    };
    return GetCallesByColoniaQuery;
}());
exports.GetCallesByColoniaQuery = GetCallesByColoniaQuery;
