...
exports.DeleteCalleCommand = void 0;
...
var DeleteCalleCommand = /** @class */ (function () {
    function DeleteCalleCommand(calleRepo) {
        this.calleRepo = calleRepo;
    }
    DeleteCalleCommand.prototype.execute = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            var existing, deletedCount, error_1, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        _a.trys.push([2, 4, , 5]);
                        return [4 /*yield*/, this.calleRepo.delete(data.calleId)];
                    case 3:
                        ...
                        if (deletedCount === 0) {
                            ...
                            throw new errors_js_1.CalleDeletionError(data.calleId, 'No se pudo eliminar la calle');
                        }
                    ...
                    case 4:
                        ...
                        if (error_1.message && error_1.message.includes('FOREIGN KEY constraint')) {
                            ...
                            throw new errors_js_1.CalleInUseError(data.calleId, ['referencias pendientes']);
                        }
                    ...
                    case 6:
                        ...
                        if (error_2 instanceof errors_js_1.CalleNotFoundError ||
                            ...
                            error_2 instanceof errors_js_1.CalleDeletionError ||
                            error_2 instanceof errors_js_1.CalleInUseError) {
                            throw error_2;
                        }
                        ...
                        throw new errors_js_1.CalleSystemError('Error interno durante la eliminación de calle');
                    case 7: return [2 /*return*/];
                }
            });
        });
    };
    return DeleteCalleCommand;
}());
exports.DeleteCalleCommand = DeleteCalleCommand;
