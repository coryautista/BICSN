...
import * as afiliadoStatusService from './infrastructure/services/AfiliadoStatusService.js';
import * as afiliadoBdiSspeaService from './infrastructure/services/AfiliadoBdiSspeaService.js';
import * as afiliadoBdiSspeaFirebirdService from './infrastructure/services/AfiliadoBdiSspeaFirebirdService.js';
import * as afiliadoBdiSspeaLoteService from './infrastructure/services/AfiliadoBdiSspeaLoteService.js';
import * as afiliadoQuincenaService from './infrastructure/services/AfiliadoQuincenaService.js';

/**
 * @deprecated Compatibility shim for pre-CQRS afiliado imports.
 * New code must use infrastructure services/repositories directly.
 * This file is intentionally retained temporarily because historical docs and
 * generated dist artifacts still reference it, but src code no longer imports it.
 */
...
export async function getQuincenaAplicacion(
  ...
  return afiliadoQuincenaService.getQuincenaAplicacion(org0, org1, org2, org3, userId);
}
...
export async function getAllStatusControl(): Promise<AfiliadoStatusControl[]> {
  return afiliadoStatusService.getAllStatusControl();
}
...
export async function getAfiliadosByStatus(org0: string, org1: string, numValidacion: number): Promise<AfiliadoWithStatus[]> {
  return afiliadoStatusService.getAfiliadosByStatus(org0, org1, numValidacion);
}
...
export async function cambiarAStatusAfiliado(
  ...
  return afiliadoStatusService.cambiarAStatusAfiliado(afiliadoId, numValidacionNuevo, usuarioId, motivo, observaciones, ipAddress, userAgent);
}
...
export async function cambiarStatusAfiliadosLote(
  ...
  return afiliadoStatusService.cambiarStatusAfiliadosLote(afiliadoIds, numValidacionNuevo, usuarioId, motivo, observaciones, ipAddress, userAgent);
}
...
export async function getAfiliadosPendientes(org0: string, org1: string): Promise<AfiliadoWithStatus[]> {
  return afiliadoStatusService.getAfiliadosPendientes(org0, org1);
}
...
export async function aprobarAfiliado(params: {
  ...
  return afiliadoStatusService.aprobarAfiliado(params);
}
...
export async function aprobarAfiliadosLote(
  ...
  return afiliadoStatusService.aprobarAfiliadosLote(afiliadoIds, usuarioId, motivo, observaciones, ipAddress, userAgent);
}
...
export async function cambiarStatusAfiliado(
  ...
  return afiliadoStatusService.cambiarStatusAfiliado(afiliadoId, numValidacionNuevo, usuarioId, motivo, observaciones, ipAddress, userAgent);
}
...
export async function getAfiliadoStatusHistory(afiliadoId: number): Promise<AfiliadoStatusHistory[]> {
  return afiliadoStatusService.getAfiliadoStatusHistory(afiliadoId);
}
...
export async function marcarAfiliadosCompletosParaOrganica(
  ...
  return afiliadoBdiSspeaService.marcarAfiliadosCompletosParaOrganica(org0, org1, usuarioId);
}
...
export async function actualizarBitacoraAfectacionOrg(
  ...
  return afiliadoBdiSspeaService.actualizarBitacoraAfectacionOrg(org0, org1, usuarioId);
}
...
export async function actualizarBitacoraAfectacionOrgTerminado(
  ...
  return afiliadoBdiSspeaService.actualizarBitacoraAfectacionOrgTerminado(org0, org1, usuarioId, mensaje);
}
...
export async function actualizarBitacoraAfectacionOrgTerminadoPorAfectacionId(
  ...
  return afiliadoBdiSspeaService.actualizarBitacoraAfectacionOrgTerminadoPorAfectacionId(afectacionId);
}
...
export async function getUltimaBitacoraAfectacionOrgPorOrganica(
  ...
  return afiliadoBdiSspeaService.getUltimaBitacoraAfectacionOrgPorOrganica(org0, org1);
}
...
export async function ejecutarAP_P_APLICAR(
  ...
  return afiliadoBdiSspeaFirebirdService.ejecutarAP_P_APLICAR(org0, org1, quincenaC, quincenaA, tipo);
}
...
export async function ejecutarAP_D_ENVIO_LAYOUT(
  ...
  return afiliadoBdiSspeaFirebirdService.ejecutarAP_D_ENVIO_LAYOUT(quincena, org0, org1, org2, org3);
}
...
export async function aplicarBDIsspea(
  ...
  return afiliadoBdiSspeaService.aplicarBDIsspea(afiliadoId, org0, org1, usuarioId, motivo, observaciones, ipAddress, userAgent);
}
...
export async function aplicarBDIsspeaLote(
  ...
  try {
    ...
    afiliadosParaProcesar = await afiliadoBdiSspeaLoteService.getAfiliadosElegiblesParaBdiSspea(org0, org1);
      ...
      try {
        ...
        try {
          logger.info({
            ...
            afiliadoId: afiliado.id,
            elapsedMs: Date.now() - startTime
          }, 'Iniciando actualización transaccional del afiliado');

          const updateResult = await afiliadoBdiSspeaLoteService.actualizarAfiliadoAplicadoBdiSspea({
            afiliadoId: afiliado.id,
            usuarioId,
            ipAddress,
            userAgent
          ...
          logger.debug({
            ...
            afiliadoId: afiliado.id,
            sqlExecuted: updateResult.sqlCambioEstado
          ...
          logger.debug({
            ...
            afiliadoId: afiliado.id,
            sqlExecuted: updateResult.sqlMarcarCompleto
          }, 'Afiliado marcado como completo');

          estadoActualizado = true;

          console.log(`      ✅ Estado actualizado en SQL Server (${updateResult.updateTimeMs}ms)`);
  ...
  if (todosExitosos) {
    ...
    try {
      logger.info({
        ...
        elapsedMs: Date.now() - startTime,
        timestamp: new Date().toISOString()
      }, 'Iniciando actualización transaccional de bitácora');
      ...
      const bitacoraResult = await afiliadoBdiSspeaLoteService.actualizarBitacoraAplicacionLote({
        org0,
        org1,
        usuarioId,
        afiliadosExitosos,
      ...
      console.log(`      ✅ Bitácora actualizada (${bitacoraActualizada} registro(s)) en ${bitacoraResult.bitacoraTimeMs}ms`);

      logger.info({
        operation: 'aplicarBDIsspeaLote',
        step: 'bitacoraActualizada',
        registrosActualizados: bitacoraActualizada,
        sqlExecuted: bitacoraResult.sqlBitacora,
        elapsedMs: Date.now() - startTime
      }, 'BitacoraAfectacionOrg actualizada como APLICAR para Movimientos BDIsspea');

      console.log(`\n      💾 Haciendo commit...`);
      console.log(`      ✅ Commit exitoso en ${bitacoraResult.commitTimeMs}ms`);

      logger.info({
        operation: 'aplicarBDIsspeaLote',
        step: 'commitBitacoraExitoso',
        commitTimeMs: bitacoraResult.commitTimeMs,
        elapsedMs: Date.now() - startTime
