...
exports.UpdateExpedienteArchivoCommand = void 0;
...
var UpdateExpedienteArchivoCommand = /** @class */ (function () {
    function UpdateExpedienteArchivoCommand(expedienteArchivoRepo) {
        this.expedienteArchivoRepo = expedienteArchivoRepo;
    }
    UpdateExpedienteArchivoCommand.prototype.execute = function (data, userId) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, this.expedienteArchivoRepo.update(data, userId)];
                    case 2:
                        expedienteArchivo = _a.sent();
                        logger.info(__assign(__assign({}, logContext), { updated: true }), 'Archivo de expediente actualizado exitosamente');
                    ...
                    case 3:
                        ...
                        logger.error(__assign(__assign({}, logContext), { error: error_1.message, stack: error_1.stack }), 'Error al actualizar archivo de expediente');
                        throw new errors_js_1.ExpedienteArchivoCommandError('actualización', {
    ...
    UpdateExpedienteArchivoCommand.prototype.validateInput = function (data) {
        // Validar archivoId
        if (!data.archivoId || typeof data.archivoId !== 'number' || data.archivoId <= 0) {
            throw new errors_js_1.InvalidExpedienteArchivoDataError('archivoId', 'Es requerido y debe ser un número positivo');
        }
        // Validar titulo si se proporciona
        if (data.titulo !== undefined) {
            if (typeof data.titulo !== 'string') {
                throw new errors_js_1.InvalidExpedienteArchivoDataError('titulo', 'Debe ser una cadena de texto');
            }
        ...
        if (data.fileName !== undefined) {
            if (typeof data.fileName !== 'string') {
                throw new errors_js_1.InvalidExpedienteArchivoDataError('fileName', 'Debe ser una cadena de texto');
            }
        ...
        if (data.mimeType !== undefined) {
            if (typeof data.mimeType !== 'string') {
                throw new errors_js_1.InvalidExpedienteArchivoDataError('mimeType', 'Debe ser una cadena de texto');
            }
        ...
        if (data.byteSize !== undefined) {
            if (typeof data.byteSize !== 'number' || data.byteSize <= 0) {
                throw new errors_js_1.InvalidExpedienteArchivoDataError('byteSize', 'Debe ser un número positivo');
            }
        ...
        if (data.storageProvider !== undefined) {
            if (typeof data.storageProvider !== 'string') {
                throw new errors_js_1.InvalidExpedienteArchivoDataError('storageProvider', 'Debe ser una cadena de texto');
            }
        ...
        if (data.storagePath !== undefined) {
            if (typeof data.storagePath !== 'string') {
                throw new errors_js_1.InvalidExpedienteArchivoDataError('storagePath', 'Debe ser una cadena de texto');
            }
    ...
    return UpdateExpedienteArchivoCommand;
}());
exports.UpdateExpedienteArchivoCommand = UpdateExpedienteArchivoCommand;
