...
exports.GetUltimaAfectacionQuery = void 0;
...
var GetUltimaAfectacionQuery = /** @class */ (function () {
    function GetUltimaAfectacionQuery(ultimaAfectacionRepo) {
        this.ultimaAfectacionRepo = ultimaAfectacionRepo;
    }
    GetUltimaAfectacionQuery.prototype.execute = function (filters) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, this.ultimaAfectacionRepo.findAll(filters)];
                    case 2:
                        result = _a.sent();
                        logger.info(__assign(__assign({}, logContext), { resultCount: result.length }), 'Consulta de últimas afectaciones completada exitosamente');
                        return [2 /*return*/, result];
                    case 3:
                        error_1 = _a.sent();
                        logger.error(__assign(__assign({}, logContext), { error: error_1.message, stack: error_1.stack }), 'Error al consultar últimas afectaciones');
                        throw new errors_js_1.AfectacionQueryError('getUltimaAfectacion', {
    ...
    GetUltimaAfectacionQuery.prototype.validateFilters = function (filters) {
        var _a, _b, _c;
    ...
    return GetUltimaAfectacionQuery;
}());
exports.GetUltimaAfectacionQuery = GetUltimaAfectacionQuery;
