...
exports.GetTableroAfectacionQuery = void 0;
...
var GetTableroAfectacionQuery = /** @class */ (function () {
    function GetTableroAfectacionQuery(tableroAfectacionRepo) {
        this.tableroAfectacionRepo = tableroAfectacionRepo;
    }
    GetTableroAfectacionQuery.prototype.execute = function (filters) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, this.tableroAfectacionRepo.findAll(filters)];
                    case 2:
                        result = _a.sent();
                        logger.info(__assign(__assign({}, logContext), { resultCount: result.length }), 'Consulta de tablero completada exitosamente');
                        return [2 /*return*/, result];
                    case 3:
                        error_1 = _a.sent();
                        logger.error(__assign(__assign({}, logContext), { error: error_1.message, stack: error_1.stack }), 'Error al consultar tablero de afectaciones');
                        throw new errors_js_1.AfectacionQueryError('getTableroAfectacion', {
    ...
    GetTableroAfectacionQuery.prototype.validateFilters = function (filters) {
        var _a, _b, _c;
    ...
    return GetTableroAfectacionQuery;
}());
exports.GetTableroAfectacionQuery = GetTableroAfectacionQuery;
