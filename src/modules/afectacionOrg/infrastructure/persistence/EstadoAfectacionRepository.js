...
exports.EstadoAfectacionRepository = void 0;
var mssql_1 = require("mssql");
var EstadoAfectacionRepository = /** @class */ (function () {
    function EstadoAfectacionRepository(mssqlPool) {
        this.mssqlPool = mssqlPool;
    }
    EstadoAfectacionRepository.prototype.findAll = function (filters) {
    ...
    return EstadoAfectacionRepository;
}());
exports.EstadoAfectacionRepository = EstadoAfectacionRepository;
