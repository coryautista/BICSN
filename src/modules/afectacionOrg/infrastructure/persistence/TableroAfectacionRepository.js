...
exports.TableroAfectacionRepository = void 0;
var mssql_1 = require("mssql");
var TableroAfectacionRepository = /** @class */ (function () {
    function TableroAfectacionRepository(mssqlPool) {
        this.mssqlPool = mssqlPool;
    }
    TableroAfectacionRepository.prototype.findAll = function (filters) {
    ...
    return TableroAfectacionRepository;
}());
exports.TableroAfectacionRepository = TableroAfectacionRepository;
