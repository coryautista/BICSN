...
import { GetHistorialMovimientosQuincenaSqlQuery } from '../modules/afiliado/application/queries/GetHistorialMovimientosQuincenaSqlQuery.js';
import { GetHistorialMovimientosQuincenaFirebirdQuery } from '../modules/afiliado/application/queries/GetHistorialMovimientosQuincenaFirebirdQuery.js';
...
import { GetOrganica1DynamicQuery } from '../modules/organica1/application/queries/GetOrganica1DynamicQuery.js';
...
import { GetOrganica2DynamicQuery } from '../modules/organica2/application/queries/GetOrganica2DynamicQuery.js';
...
import { GetOrganica3DynamicQuery } from '../modules/organica3/application/queries/GetOrganica3DynamicQuery.js';
...
import { GetAppliedQnaDetailsQuery } from '../modules/liquidacionQna/application/queries/GetAppliedQnaDetailsQuery.js';
...
import { GetHistoricoQuincenalPorTipoQuery } from '../modules/historicosQuincenales/application/queries/GetHistoricoQuincenalPorTipoQuery.js';
...
import { LineaCapturaPeriodoRepository } from '../modules/reportes/aplicacionesQNA/infrastructure/persistence/LineaCapturaPeriodoRepository.js';
...
import { GenerateLineaCapturaPeriodoCommand } from '../modules/reportes/aplicacionesQNA/application/commands/GenerateLineaCapturaPeriodoCommand.js';
import { GetLineaCapturaPeriodoQuery } from '../modules/reportes/aplicacionesQNA/application/queries/GetLineaCapturaPeriodoQuery.js';
...
import { GetEntidadesRptPdfInsertaQuery } from '../modules/aplicacionQuincenal/application/queries/GetEntidadesRptPdfInsertaQuery.js';
import { ValidarAplicacionQnaAportacionesQuery } from '../modules/aplicacionQuincenal/application/queries/ValidarAplicacionQnaAportacionesQuery.js';
...
container.register({
  ...
  getHistorialMovimientosQuincenaSqlQuery: asClass(GetHistorialMovimientosQuincenaSqlQuery).scoped(),
  getHistorialMovimientosQuincenaFirebirdQuery: asClass(GetHistorialMovimientosQuincenaFirebirdQuery).scoped(),
  ...
  historicosQuincenalesRepo: asClass(HistoricosQuincenalesRepository).scoped(),
  getHistoricoQuincenalPorTipoQuery: asClass(GetHistoricoQuincenalPorTipoQuery).scoped(),
  ...
  getOrganica1DynamicQuery: asClass(GetOrganica1DynamicQuery).scoped(),
  ...
  getOrganica2DynamicQuery: asClass(GetOrganica2DynamicQuery).scoped(),
  ...
  getOrganica3DynamicQuery: asClass(GetOrganica3DynamicQuery).scoped(),
  ...
  lineaCapturaPeriodoRepo: asClass(LineaCapturaPeriodoRepository).scoped(),
  ...
  getLineaCapturaPeriodoQuery: asClass(GetLineaCapturaPeriodoQuery).scoped(),

  // Commands (Scoped)
  generateLineaCapturaPeriodoCommand: asClass(GenerateLineaCapturaPeriodoCommand).scoped(),
  ...
  getEntidadesRptPdfInsertaQuery: asClass(GetEntidadesRptPdfInsertaQuery).scoped(),
  validarAplicacionQnaAportacionesQuery: asClass(ValidarAplicacionQnaAportacionesQuery).scoped(),
  ...
  getAppliedQnaDetailsQuery: asClass(GetAppliedQnaDetailsQuery).scoped(),
