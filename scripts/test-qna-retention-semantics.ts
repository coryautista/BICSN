...
assert.throws(() => validateQnaRetentionSemantics(details, [sources[0], sources[1], source('HIP', 'FIREBIRD:AP_S_COMP_QNA:DESARROLLO:1726:04:24')], context), /Procedencia HIP/);
validateQnaRetentionSemantics(details, sources, context, { retentionProvenanceMode: 'PERSISTED_HISTORICAL' });
validateQnaRetentionSemantics(details, [sources[0], sources[1], source('HIP', 'FIREBIRD:AP_S_COMP_QNA:DESARROLLO:1726:04:24')],
  context, { retentionProvenanceMode: 'PERSISTED_HISTORICAL' });
assert.throws(() => validateQnaRetentionSemantics(details,
  [sources[0], sources[1], source('HIP', 'FIREBIRD:OTRO:DESARROLLO:1726:04:24')], context,
