...
IF COL_LENGTH(N'config.FirebirdOrganicaCredential', N'RolFirebirdEntidad') IS NULL
  THROW 51901, 'FIREBIRD_CATALOG_ROL_ENTIDAD_FALTANTE', 1;
...
) THROW 51902, 'FIREBIRD_CATALOG_ROL_ENTIDAD_FIRMA_INVALIDA', 1;

PRINT 'FIREBIRD_CATALOG_ROL_ENTIDAD_VERIFY_OK';
