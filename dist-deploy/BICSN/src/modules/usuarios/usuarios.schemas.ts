...
const organicaSchema = z.string().trim().regex(/^[A-Za-z0-9]{1,2}$/, 'La clave orgánica debe ser alfanumérica de 1 a 2 caracteres');
const organicaOptionalSchema = z.string().trim().regex(/^[A-Za-z0-9]{1,2}$/, 'La clave orgánica debe ser alfanumérica de 1 a 2 caracteres').optional().or(z.literal(''));
...
export const CreateUsuarioSchema = z.object({
  ...
  idOrganica0: organicaSchema,
  idOrganica1: organicaSchema,
  idOrganica2: organicaOptionalSchema,
  idOrganica3: organicaOptionalSchema
});
