    ...
    schema: {
      ...
      body: {
        ...
        properties: {
          ...
          idOrganica0: { type: 'string', pattern: '^[A-Za-z0-9]{1,2}$' },
          idOrganica1: { type: 'string', pattern: '^[A-Za-z0-9]{1,2}$' },
          idOrganica2: { type: 'string', pattern: '^[A-Za-z0-9]{0,2}$' },
          idOrganica3: { type: 'string', pattern: '^[A-Za-z0-9]{0,2}$' }
        }
      },
      response: {
        201: {
